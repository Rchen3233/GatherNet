# This GatherNet implementation is based on the DenseNet-BC implementation in torchvision
# reference : DenseNet-BC、MobileNets、ShuffleNet、GhostNet、SENet
...
class First_layer(nn.Module):
    ...
    def forward(self, x):
        ...
        x8 = self.features.shuffle0(x7)
        return x8


class GatherNet(nn.Module):
    r"""GatherNet model class, based on
    ...
    """
    def __init__(self, growth_rate=12, block_config=(4, 4, 4), compression=0.5,
